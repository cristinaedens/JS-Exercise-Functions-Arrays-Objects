...
*/
function makeSmartPerson(theirName) {
 const myObject={
   name: theirName,
   ...
   speak: function(){
     return `Hello, my name is ${theirName}`
   }
 }
 return myObject
}
...
const variableCar= inventory[index]
return `This is a ${variableCar.car_make} ${variableCar.car_model}`
}
